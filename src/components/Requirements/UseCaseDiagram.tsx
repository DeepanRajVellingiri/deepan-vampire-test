import { Users, Shield, Brain, FileText, CheckCircle2, XCircle, Cog, Bell, BarChart } from 'lucide-react';
  ...
  return (
    <div>
        ...
        <div className="min-w-[800px]">
          <div className="flex justify-center mb-8">
            <div className="relative">
              {/* System boundary */}
              <div className="absolute inset-0 border-2 border-gray-300 rounded-lg -m-4"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {actors.map((actor) => (
          <div key={actor.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div key={index} className="relative">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div className="flex items-center mb-2">
                          {step.actor === 'Requester' ? (
                            <Users className="h-5 w-5 text-blue-600 mr-2" />
                          ) : step.actor === 'Business Approver' ? (
                            <Shield className="h-5 w-5 text-purple-600 mr-2" />
                          ) : step.actor === 'Technical Approver' ? (
